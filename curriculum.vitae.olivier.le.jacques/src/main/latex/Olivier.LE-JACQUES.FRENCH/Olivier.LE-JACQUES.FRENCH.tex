...
\begin{rubriquetableau}[\firstcolumnwidth]{Expériences Professionnelles}
    \input{\experiencedir/01-infotel} \\
	\input{\experiencedir/02-cea} \\
	\input{\experiencedir/03-erasmus} \\
	\input{\experiencedir/04-hewlett-packard} \\
	\input{\experiencedir/05-timisoara} \\
\end{rubriquetableau}
